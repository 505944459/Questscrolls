...
public class ReadTime {
    ...
    public static void loads(){ //读取
        fileConfiguration = YamlConfiguration.loadConfiguration(new File(com.king.Zhu.getPlugin(com.king.Zhu.class).getDataFolder(),"playerlogin.yml"));
    ...
    public static void saves(){ //保存
        ...
        try {
            fileConfiguration.save(new File(com.king.Zhu.getPlugin(com.king.Zhu.class).getDataFolder(),"/playerlogin.yml"));
        }catch (Exception e){
            System.out.println("");
        }
